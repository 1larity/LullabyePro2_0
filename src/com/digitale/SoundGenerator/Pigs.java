...
public class Pigs {
	...
	/**
	 * Generate random number and play pigs as appropriate
	 * @param currentVolume
	 */
	public void pigs(AnimationView animationView, float currentVolume) {
		Random random = new Random();
		int RandomNumber = random.nextInt(Lullabye.getMscaleRandom());
		if ((RandomNumber >= 270) && (RandomNumber <= 279)) {
